...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-alerts.html">
              <i class="bi bi-circle"></i><span>Thêm sản phẩm mới</span>
            </a>
          </li>
          <li>
            <a href="components-alerts.html">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.html">
              <i class="bi bi-circle"></i><span>Thêm thương hiệu mới</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Hóa đơn</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Rice 3 Man</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
